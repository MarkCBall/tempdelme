...
//
const getSearchTokenQueryVelox = (tableSuffix) => {
  return gql`
...
const getSearchTokenQueryRome = (blockchain) => {
  return gql`
...
export const getDirectPairsVelox =
  // memoizeOne(
  async (tableSuffix, requiredDirectPairWithToken) => {
...
export const getDirectPairsRome =
  // memoizeOne(
  async (
    blockchain,
    exchange,
