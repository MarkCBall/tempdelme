...
import { searchTokenPairs, startSelecting, toggleSelecting, setSearchText, setDebounce } from '../redux/tokenSearchSlice';
  ...
  return (
    <PairField onClick={() => dispatch(startSelecting())}>
      <StyledInput
        ...
        autocomplete={'off'}
        maxLength="48"
        onChange={e => dispatch(setSearchText({ text: mutatorTextToken(e.target, searchToken, dispatch), debounceDelay: 450 }))}
      />
      <HideOnSmallScreen
        alt={''}
        src={magnifyingGlass}
